...
2. Continue splitting `VisualWorkspace.jsx` into smaller React modules so compact text can move away from selector-discovery compatibility. The workspace model and Submit Decision panel are already split.
