...
- `tests/profile-browser.spec.mjs` verifies the approved contextual Profile on desktop and Pixel 7, including avatar entry from Workspace and Dashboard, neutral rank/skill/badge/goal metrics, Workspace/Academy/Progress routes, four-item navigation, isolation, and viewport safety.
