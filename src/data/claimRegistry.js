...
export const coreClaimTypes = [
  {
    ...
    prefix: 'ATO',
    lane: 'Account access',
    subtypes: ['credential stuffing', 'phishing', 'OTP phishing', 'vishing', 'SIM swap', 'session hijack'],
    ...
    availableTools: ['Customer 360', 'Login History', 'Session History', 'Device Intelligence', 'IP Intelligence', 'Transaction History', 'Payment Verification', 'Evidence Center', 'Document Request', 'Link Analysis', 'Timeline'],
    requiredTools: ['Case Summary', 'Customer 360', 'Login History', 'Device Intelligence', 'Transaction History', 'Evidence Center', 'Link Analysis'],
  ...
  },
  {
    ...
    prefix: 'FCB',
    lane: 'Card dispute',
    subtypes: ['lost card', 'stolen card', 'counterfeit/skimming', 'CNP fraud', 'digital wallet token fraud', 'ATM/POS fraud'],
    ...
    availableTools: ['Customer 360', 'Transaction History', 'Payment Verification', 'Login History', 'Session History', 'Device Intelligence', 'Evidence Center', 'Document Request', 'Link Analysis', 'Timeline'],
    requiredTools: ['Case Summary', 'Customer 360', 'Transaction History', 'Payment Verification', 'Evidence Center', 'Link Analysis'],
  ...
  },
  {
    ...
    availableTools: ['Customer 360', 'Transaction History', 'Business 360', 'Payment Verification', 'Evidence Center', 'Document Request', 'Link Analysis', 'Timeline'],
  ...
  },
  {
    ...
    subtypes: ['friendly fraud', 'false dispute after delivery', 'misrepresented income', 'repeat claim pattern'],
    ...
    availableTools: ['Customer 360', 'Transaction History', 'Business 360', 'Evidence Center', 'Document Request', 'Link Analysis', 'Timeline'],
    requiredTools: ['Case Summary', 'Customer 360', 'Transaction History', 'Evidence Center', 'Link Analysis'],
  ...
  },
  {
    ...
    subtypes: ['employee direct deposit change', 'payroll administrator change', 'ghost employee concern', 'duplicate payroll destination'],
    ...
    availableTools: ['Business 360', 'Employee Profile', 'Payroll History', 'Payment Verification', 'Identity Intel / People Search', 'Evidence Center', 'Document Request', 'Link Analysis', 'Timeline'],
    requiredTools: ['Case Summary', 'Business 360', 'Employee Profile', 'Payroll History', 'Payment Verification', 'Evidence Center'],
  ...
  },
  {
    ...
    subtypes: ['vendor payment change', 'employee email compromise', 'executive impersonation', 'beneficiary change'],
    ...
    availableTools: ['Identity Intel / People Search', 'Payment Verification', 'Business 360', 'Business Intelligence', 'Transaction History', 'Evidence Center', 'Document Request', 'Link Analysis', 'Timeline'],
    requiredTools: ['Case Summary', 'Identity Intel / People Search', 'Payment Verification', 'Business 360', 'Evidence Center', 'Link Analysis'],
  ...
  },
  {
    ...
    availableTools: ['Customer 360', 'Identity Intel / People Search', 'Payment Verification', 'Financial Intelligence', 'Transaction History', 'Business 360', 'Employee Profile', 'Payroll History', 'Evidence Center', 'Document Request', 'Link Analysis', 'Timeline'],
  ...
  },
  {
    ...
    subtypes: ['sleeper LLC sudden draw', 'rapid credit line stacking', 'synthetic owner identity', 'revenue mismatch', 'large draw after limit increase', 'business legitimacy mismatch'],
    ...
    availableTools: ['Business 360', 'Business Intelligence', 'Identity Intel / People Search', 'Financial Intelligence', 'Transaction History', 'Payment Verification', 'Evidence Center', 'Document Request', 'Link Analysis', 'Timeline'],
    requiredTools: ['Case Summary', 'Business 360', 'Business Intelligence', 'Financial Intelligence', 'Evidence Center', 'Document Request'],
  ...
  },
  {
    ...
    availableTools: ['Customer 360', 'Identity Intel / People Search', 'Device Intelligence', 'IP Intelligence', 'Login History', 'Payment Verification', 'Evidence Center', 'Document Request', 'Link Analysis', 'Timeline'],
    requiredTools: ['Case Summary', 'Customer 360', 'Identity Intel / People Search', 'Device Intelligence', 'IP Intelligence', 'Evidence Center'],
  ...
  },
  {
    ...
    availableTools: ['Transaction History', 'Payment Verification', 'Identity Intel / People Search', 'Business 360', 'Evidence Center', 'Document Request', 'Link Analysis', 'Timeline'],
    requiredTools: ['Case Summary', 'Transaction History', 'Payment Verification', 'Evidence Center', 'Document Request', 'Link Analysis'],
