...
const businessTools = ['Business 360', 'KYB Review', 'Identity Intel / People Search'];
...
const definitions = [
  {
    ...
    availableTools: [...personalTools, 'Transaction History', 'Merchant Intelligence', ...accessTools.slice(0, 3), ...commonTools],
  ...
  },
  {
    ...
    availableTools: ['Customer 360', 'Transaction History', 'Merchant Intelligence', ...commonTools],
  ...
  },
  {
    ...
    availableTools: [...personalTools, ...accessTools, 'Transaction History', 'Payment Verification', ...commonTools],
  ...
  },
  {
    ...
    requiredTools: ['Case Summary', 'Business 360', 'KYB Review', 'Login History', 'Session History', 'Device Intelligence', 'IP Intelligence', 'Transaction History', 'Link Analysis'],
  ...
  },
  {
    ...
    availableTools: ['Business 360', 'KYB Review', 'Employee Profile', 'Payroll History', ...paymentTools, ...accessTools, ...commonTools],
