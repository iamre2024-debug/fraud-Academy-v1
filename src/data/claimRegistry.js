...
const claimTypeDefinitions = [
  ...
  },
  {
    ...
    availableTools: ['Business 360', 'Employee Profile', 'Payroll History', 'Financial Investigation', 'Payment Verification', 'Identity Intel / People Search', 'Login History', 'Session History', 'Device Intelligence', 'IP Intelligence', 'Document Viewer', 'Document Request', 'Link Analysis', 'Timeline'],
  ...
  },
  {
    ...
    availableTools: ['Identity Intel / People Search', 'Payment Verification', 'Business 360', 'Login History', 'Session History', 'Device Intelligence', 'IP Intelligence', 'Transaction History', 'Financial Investigation', 'Document Viewer', 'Document Request', 'Link Analysis', 'Timeline'],
  ...
  },
  {
    ...
    availableTools: ['Customer 360', 'Identity Intel / People Search', 'Payment Verification', 'Financial Investigation', 'Transaction History', 'Business 360', 'Employee Profile', 'Payroll History', 'Document Viewer', 'Document Request', 'Link Analysis', 'Timeline'],
  ...
  },
  {
    ...
    availableTools: ['Business 360', 'Identity Intel / People Search', 'Financial Investigation', 'Transaction History', 'Payment Verification', 'Document Viewer', 'Document Request', 'Link Analysis', 'Timeline'],
    requiredTools: ['Case Summary', 'Business 360', 'Financial Investigation', 'Document Viewer', 'Document Request'],
  ...
  },
  {
    ...
    availableTools: ['Transaction History', 'Financial Investigation', 'Payment Verification', 'Identity Intel / People Search', 'Business 360', 'Document Viewer', 'Document Request', 'Link Analysis', 'Timeline'],
