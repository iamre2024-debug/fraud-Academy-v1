...
const payrollPaymentTools = ['Financial Investigation', 'Payment Verification'];
...
const definitions = [
  ...
  },
  {
    ...
    availableTools: ['Business 360', 'Employee Profile', 'Payroll History', ...payrollPaymentTools, ...accessTools, ...commonTools],
  ...
  },
  {
    ...
    productTypes: [PRODUCT_TYPES.CREDIT_CARD, PRODUCT_TYPES.PERSONAL_LOAN, PRODUCT_TYPES.BUSINESS_CREDIT_CARD, PRODUCT_TYPES.BUSINESS_LOAN],
