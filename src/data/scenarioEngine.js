...
export const scenarioTemplates = [
  ...
  },
  {
    ...
    requiredFamilies: ['Case Summary', 'Customer 360', 'Identity Intel / People Search', 'Payment Verification', 'Financial Intelligence', 'Login History', 'Evidence Center'],
  ...
  },
  {
    ...
    requiredFamilies: ['Case Summary', 'Business 360', 'Employee Profile', 'Payroll History', 'Payment Verification', 'Identity Intel / People Search', 'Evidence Center', 'Link Analysis'],
