    ...
    pages: [
      ...
      page('Ownership and Institution Relationship', 'OWNERS, OFFICERS, ACCOUNTS, AND PRODUCTS · FICTIONAL TRAINING SOURCES', [
        section('Beneficial owners', [], {
          table: {
            columns: ['Record', 'Legal name', 'DOB', 'Training ID', 'Title', 'Ownership', 'Control / guarantor', 'Current residential address', 'Previous residential address', 'Owner verification'],
            rows: profile.ownership.beneficialOwners.map((owner) => [
              ...
              `${owner.controlStatus} · ${owner.guarantorStatus}`,
              owner.currentResidentialAddress,
              owner.previousResidentialAddress,
        ...
        section('Relationship servicing and access', [
