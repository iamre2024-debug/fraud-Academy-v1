...
const businessCreditProducts = [PRODUCT_TYPES.BUSINESS_CREDIT_CARD, PRODUCT_TYPES.BUSINESS_LOAN];
const businessLoanProducts = [PRODUCT_TYPES.BUSINESS_LOAN, PRODUCT_TYPES.BUSINESS_CREDIT_CARD];
