...
function IntelHeader({ icon, routeLabel, subtitle, title }) {
  return (
        ...
        <>
          <section className="mobile-intel-subject-hero mobile-business-profile-summary" aria-label="Business Match Summary">
            ...
            <div className="mobile-intel-inline-actions">
              ...
              <button type="button" className="primary" onClick={() => setReportOpen(true)}><IntelGlyph type="report" size={18} />{reportOpen ? 'Detailed Business Intel Open' : 'View Detailed Business Intel'}</button>
            </div>
          </section>
