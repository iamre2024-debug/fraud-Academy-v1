...
export default function CaseSummaryCard({ activeCase, pin, openTool, openNotes, openMoreTools }) {
  ...
  return (
    <section className="case-summary-visual case-briefing-theme-v1" aria-labelledby="case-briefing-title" data-case-briefing-screen="approved-theme-v1">
      ...
      <nav className="case-briefing-utilities" aria-label="Case briefing utilities">
        ...
        <button type="button" onClick={() => openTool('Case Report', 'summary')}><span aria-hidden="true">▤</span>Reports</button>
