...
mustContain('README', readme, 'The approved Dashboard, Cases, Workspace shell, Case Briefing, Customer 360, Investigation tools, Timeline, and Decision and Luna theme v1 replacements are merged');
...
console.log('Workspace shell approved-theme v1 smoke check passed. The compact header, active-case strip, workflow rail, responsive grid safety, synchronized Decision and Luna handoff, Evidence First wording, and protected persistence boundaries remain intact.');
