...
assert.deepEqual(migratedStoredPackage.requiredTools, ['Case Summary', 'Document Viewer', 'KYB Review']);
assert.deepEqual(migratedStoredPackage.missingTools, ['KYB Review']);
assert.equal(
...
assert.deepEqual(
  ...
  ['Case Summary', 'Document Viewer', 'Financial Investigation', 'KYB Review'],
...
assert.deepEqual(
  ...
  ['Case Summary', 'Document Viewer', 'KYB Review'],
);
