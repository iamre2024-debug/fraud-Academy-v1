...
for (const [customerType, productTypes] of [
  [CUSTOMER_TYPES.PERSONAL, [PRODUCT_TYPES.CREDIT_CARD, PRODUCT_TYPES.PERSONAL_LOAN, PRODUCT_TYPES.PERSONAL_LINE_OF_CREDIT]],
  [CUSTOMER_TYPES.BUSINESS, [PRODUCT_TYPES.PAYROLL_PRODUCT, PRODUCT_TYPES.BUSINESS_CREDIT_CARD, PRODUCT_TYPES.BUSINESS_LOAN, PRODUCT_TYPES.BUSINESS_LINE_OF_CREDIT]],
]) {
