...
for (const [customerType, productTypes] of [
  ...
  [CUSTOMER_TYPES.BUSINESS, [PRODUCT_TYPES.BUSINESS_CREDIT_CARD, PRODUCT_TYPES.BUSINESS_LOAN]],
]) {
...
assert.equal(
  isWorkflowEnabled(CUSTOMER_TYPES.BUSINESS, PRODUCT_TYPES.PAYROLL_PRODUCT, WORKFLOW_TYPES.CREDIT_APPLICATION_REVIEW),
  false,
);
assert.equal(
  isWorkflowEnabled(CUSTOMER_TYPES.BUSINESS, PRODUCT_TYPES.PAYROLL_PRODUCT, WORKFLOW_TYPES.CREDIT_RISK_REVIEW),
  false,
);
